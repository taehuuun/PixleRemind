...
public class CollectTopicData
{
    ...
    public CollectTopicData(string title, int completeCount, int totalCount, List<CollectPixelArtData> collectPixelArtDataList)
    {
        Title = title;
        CompleteCount = completeCount;
        TotalCount = totalCount;
        CollectPixelArtDataList = collectPixelArtDataList;
    }
}